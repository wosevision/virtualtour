...
console.log('nztour', nzTour)

import './welcome.scss';

const TOUR_CONFIG: nztour.ITourStepConfig = {
  mask: {
    visible: true,
...
const TOUR_STEPS: nztour.ITourStep[] = [{
  target: '#locations',
...
const WELCOME_TIPS: { [key: string]: vt.IWelcomeTipGroup } = {
  navigation: {
...
const WELCOME_TIP_LIST: vt.IWelcomeTip[] = [
  [{
...
.constant('TOUR_CONFIG', TOUR_CONFIG)

.constant('TOUR_STEPS', TOUR_STEPS)

.constant('WELCOME_TIPS', WELCOME_TIPS)

.constant('WELCOME_TIP_LIST', WELCOME_TIP_LIST)
